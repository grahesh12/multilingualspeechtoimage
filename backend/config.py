...
BACKEND_DIR = r"C:\D\project\Project_FR-FIX\backend"

# Memory Management Settings
MAX_MODELS_IN_MEMORY = 1  # Number of models to keep in memory simultaneously
MODEL_TIMEOUT = 30  # Seconds before unloading unused models (30 Sec)
...
# Cleanup Settings
CLEANUP_INTERVAL = 6  # Seconds between automatic cleanups
